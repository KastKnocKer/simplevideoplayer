...
bool Bitmap::loadBMP(char *file) {
    ...
    bpp=bmih.biBitCount;
	std::cout << "biBitCount      =" << bmih.biBitCount << std::endl;
	std::cout << "biClrImportant  =" << bmih.biClrImportant << std::endl;
	std::cout << "biClrUsed       =" << bmih.biClrUsed << std::endl;
	std::cout << "biCompression   =" << bmih.biCompression << std::endl;
	std::cout << "biHeight        =" << bmih.biHeight << std::endl;
	std::cout << "biPlanes        =" << bmih.biPlanes << std::endl;
	std::cout << "biSize          =" << bmih.biSize << std::endl;
	std::cout << "biSizeImage     =" << bmih.biSizeImage << std::endl;
	std::cout << "biWidth         =" << bmih.biWidth << std::endl;
	std::cout << "biXPelsPerMeter =" << bmih.biXPelsPerMeter << std::endl;
	std::cout << "biYPelsPerMeter =" << bmih.biYPelsPerMeter << std::endl;
