...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DecodeThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 39, 3)
    ...
    "DecodeThread\0setSliderRange\0\0start\0"
    "end\0eof\0"
};
...
void DecodeThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setSliderRange((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->eof(); break;
        default: ;
        }
        ...
        {
            typedef void (DecodeThread::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DecodeThread::setSliderRange)) {
                *result = 0;
            }
        }
        {
            typedef void (DecodeThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DecodeThread::eof)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void DecodeThread::setSliderRange(int _t1, int _t2)
{
