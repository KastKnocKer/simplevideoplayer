...
QT_MOC_LITERAL(4, 30, 11)
    ...
    "Video\0windowClosing\0\0Xpressed\0closeWindow\0"
};
...
void Video::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Video::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Video::windowClosing)) {
                *result = 0;
            }
        }
        {
            typedef void (Video::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Video::Xpressed)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject Video::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_Video.data,
